...
extern char CTRL_MODE[20], LAST_SLEEP_TRIG[5], LAST_WAKE_TRIG[5], VL_SLEEP_SYMBOL, VL_WAKE_SYMBOL, VCHG_SYMBOL;
extern uint16_t UART_SLEEP_TIM, UART_WAKE_TIM_L, UART_WAKE_TIM_H, VL_SLEEP_TIM, VL_WAKE_TIM, VCHG_WAKE_TIM, EXT_SLEEP_TIM, EXT_WAKE_TIM, VL_SLEEP_STEPS, VL_WAKE_STEPS, VCHG_WAKE_STEPS;
extern float VL_SLEEP_VOLT, VL_WAKE_VOLT, VCHG_WAKE_VOLT;
extern bool MASTER_EN, UART_ALERT, PWR_CTRL, UART_SLEEP, UART_WAKE, EXT_INPUT, EXT_SLEEP, EXT_WAKE, VL_SLEEP, VL_WAKE, VCHG_WAKE, STSLXP_VAL, UART_INACTIVITY_ALERT, VL_WAKE_CONVERT, VCHG_CONVERT, VL_SLEEP_CONVERT;
...
*/
void PM_STSLVLS(char , int , uint16_t );
...
*/
void PM_STSLVLW(char , int , uint16_t );
...
/**
  ...
  @Param
 * char of symbol, either '-' or '+', else it will be considered as both
...
*/
void PM_STSLVGW(char, int, uint16_t);
...
/**
  @Summary
    Checks VL SLEEP is triggered.

  @Description
    This routine checks if the VL SLEEP is triggered, if returns a boolean value accordingly.
  ...
  @Returns
    Boolean value stating if VL SLEEP is triggered.
 
  @Example 
    <code>    
        bool VL_WAKE = PM_Check_VL_SLEEP();
    </code>
*/
...
/**
  ...
  @Example 
    <code>    
        bool VL_WAKE = PM_Check_VL_WAKE();
    </code>
*/
bool PM_Check_VL_WAKE(void);
